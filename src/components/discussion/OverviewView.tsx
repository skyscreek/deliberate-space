...
import ContributionGuidance from '@/components/deliberation/ContributionGuidance';
...
export default function OverviewView({ topic, onSwitchToThread, onSwitchToArgType }: Props) {
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-300">
      ...
      {/* Contribution guidance (from earlier mockups / sidebar) */}
      {topic.guidance && topic.guidance.length > 0 && (
        <section className="surface-card p-4 rounded-xl border border-border/40">
