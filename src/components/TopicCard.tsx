    ...
    <Link to={href} className="flex gap-4 px-4 py-3.5 hover:bg-secondary/40 transition-colors group">
      ...
      <div className="flex-1 min-w-0 space-y-1.5">
        <div className="flex items-center gap-2 flex-wrap">
          <Badge variant="outline" className="text-[10px] font-medium px-1.5 py-0">{topic.category}</Badge>
          <Badge className={`text-[10px] border px-1.5 py-0 ${statusColors[topic.status]}`}>
