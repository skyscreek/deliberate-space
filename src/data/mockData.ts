...
const authors = {
  maria:  { id: 'a1',  name: 'Maria Chen',       avatar: 'MC', color: '210 50% 55%', role: 'Urban Planner' },
  james:  { id: 'a2',  name: 'James Okafor',      avatar: 'JO', color: '160 45% 45%', role: 'Daily Commuter' },
  linda:  { id: 'a3',  name: 'Linda Vasquez',      avatar: 'LV', color: '280 40% 50%', role: 'Environmental Researcher' },
  tom:    { id: 'a4',  name: 'Tom Brennan',        avatar: 'TB', color: '20 55% 50%',  role: 'Small Business Owner' },
  aisha:  { id: 'a5',  name: 'Aisha Patel',        avatar: 'AP', color: '340 45% 50%', role: 'Disability Advocate' },
  chen:   { id: 'a6',  name: 'Chen Wei',           avatar: 'CW', color: '180 40% 45%', role: 'Transit Rider' },
  sarah:  { id: 'a7',  name: 'Sarah Johansson',    avatar: 'SJ', color: '250 45% 55%', role: 'Graduate Student' },
  mike:   { id: 'a8',  name: 'Mike DeLuca',        avatar: 'MD', color: '30 50% 48%',  role: 'Delivery Driver' },
  priya:  { id: 'a9',  name: 'Priya Sharma',       avatar: 'PS', color: '310 40% 50%', role: 'Data Analyst' },
  david:  { id: 'a10', name: 'David Kim',          avatar: 'DK', color: '200 45% 48%', role: 'City Council Aide' },
};
...
const argumentMap: ArgumentNode[] = [
  {
    ...
    children: [
      ...
      { id: 'am-1-2', type: 'support', status: 'unresolved', strength: 0.5, text: 'Pediatric asthma rates downtown are 40% above city average — health costs of inaction are real', author: 'Linda Vasquez', relatedPostIds: ['p3'], children: [] },
      {
        ...
        children: [
          { id: 'am-1-3-1', type: 'support', text: 'Bus routes to suburbs were cut 3 years ago — many commuters have zero alternative', author: 'James Okafor', relatedPostIds: ['p2'], children: [] },
          { id: 'am-1-3-2', type: 'support', text: 'For minimum wage workers, the fee is a much bigger share of income', author: 'Tom Brennan', relatedPostIds: ['p7'], children: [] },
        ],
      },
      {
...
export const congestionTopic: Topic = {
  ...
  lastActivity: '2026-03-07T16:30:00Z',
  participantCount: 47,
  postCount: 10,
  ...
  summary: {
    ...
    openQuestions: [],
    emergingProposals: [
      { id: 'ep-1', title: 'Phased pricing with transit investment first', description: 'Start at $4–5, invest revenue in transit for 2 years, then raise to $9 once alternatives exist.', supportedBy: ['Sarah Johansson'], relatedPostIds: ['p10'] },
      { id: 'ep-2', title: 'Broad exemptions with sliding scale', description: 'Exemptions for disabled residents, caregivers, and a sliding scale replacing the hard poverty-line cutoff.', supportedBy: ['Aisha Patel', 'David Kim'], relatedPostIds: ['p5', 'p9'] },
    ],
  },
  ...
  posts: [
    {
      id: 'p1', author: authors.maria, score: 24, argdownType: 'claim',
      ...
      reactions: [{ type: 'support', count: 12, userReacted: false }, { type: 'nuance', count: 3, userReacted: false }, { type: 'disagree', count: 1, userReacted: false }],
      replies: [{
        id: 'r1-1', author: authors.sarah, score: 14, argdownType: 'concern',
        ...
        reactions: [{ type: 'support', count: 8, userReacted: false }, { type: 'nuance', count: 2, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
        replies: [{
          id: 'r1-1-1', author: authors.maria, score: 6, argdownType: 'rebuttal',
          content: 'Fair point. That\'s exactly why I think the revenue earmarking is crucial — we need to build the infrastructure gap into the policy design rather than assume it already exists.',
          createdAt: '2026-03-01T13:00:00Z',
          reactions: [{ type: 'support', count: 4, userReacted: false }, { type: 'nuance', count: 1, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
        }],
      }],
    },
    {
      id: 'p2', author: authors.james, score: 31, argdownType: 'objection',
      ...
      reactions: [{ type: 'support', count: 18, userReacted: false }, { type: 'nuance', count: 1, userReacted: false }, { type: 'disagree', count: 3, userReacted: false }],
      replies: [],
    },
    {
      id: 'p3', author: authors.linda, score: 16, argdownType: 'evidence',
      ...
      reactions: [{ type: 'support', count: 9, userReacted: false }, { type: 'nuance', count: 5, userReacted: false }, { type: 'disagree', count: 2, userReacted: false }],
      replies: [{
        id: 'r3-1', author: authors.james, score: 19, argdownType: 'concern',
        ...
        reactions: [{ type: 'support', count: 14, userReacted: false }, { type: 'nuance', count: 0, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
      }],
    },
    {
      id: 'p4', author: authors.tom, score: 18, argdownType: 'objection',
      ...
      reactions: [{ type: 'support', count: 11, userReacted: false }, { type: 'nuance', count: 2, userReacted: false }, { type: 'disagree', count: 1, userReacted: false }],
      replies: [],
    },
    {
      id: 'p5', author: authors.aisha, score: 34, argdownType: 'claim',
      ...
      reactions: [{ type: 'support', count: 22, userReacted: false }, { type: 'nuance', count: 0, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
      replies: [],
    },
    {
      id: 'p6', author: authors.chen, score: 22, argdownType: 'question',
      ...
      reactions: [{ type: 'support', count: 15, userReacted: false }, { type: 'nuance', count: 4, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
      replies: [],
    },
    {
      id: 'p7', author: authors.priya, score: 11, argdownType: 'evidence',
      ...
      reactions: [{ type: 'support', count: 7, userReacted: false }, { type: 'nuance', count: 6, userReacted: false }, { type: 'disagree', count: 2, userReacted: false }],
      replies: [{
        id: 'r7-1', author: authors.tom, score: 12, argdownType: 'rebuttal',
        ...
        reactions: [{ type: 'support', count: 9, userReacted: false }, { type: 'nuance', count: 1, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
      }],
    },
    {
      id: 'p8', author: authors.mike, score: 17, argdownType: 'objection',
      ...
      reactions: [{ type: 'support', count: 13, userReacted: false }, { type: 'nuance', count: 1, userReacted: false }, { type: 'disagree', count: 1, userReacted: false }],
      replies: [],
    },
    {
      id: 'p9', author: authors.david, score: 9, argdownType: 'support',
      ...
      reactions: [{ type: 'support', count: 6, userReacted: false }, { type: 'nuance', count: 8, userReacted: false }, { type: 'disagree', count: 3, userReacted: false }],
      replies: [{
        id: 'r9-1', author: authors.aisha, score: 15, argdownType: 'concern',
        ...
        reactions: [{ type: 'support', count: 11, userReacted: false }, { type: 'nuance', count: 2, userReacted: false }, { type: 'disagree', count: 0, userReacted: false }],
      }],
    },
    {
      id: 'p10', author: authors.sarah, score: 28, argdownType: 'proposal',
      ...
      reactions: [{ type: 'support', count: 20, userReacted: false }, { type: 'nuance', count: 3, userReacted: false }, { type: 'disagree', count: 2, userReacted: false }],
      replies: [],
    },
  ],

  tensions: [
    { id: 't1', label: 'Economic Burden vs. Environmental Benefit', sideA: 'The fee disproportionately hurts low-income commuters and small businesses who have no viable alternative', sideB: 'Inaction has serious health and environmental costs that also fall on vulnerable communities', relatedPostIds: ['p2', 'p3', 'p4', 'p7'] },
    { id: 't2', label: 'Immediate Action vs. Transit-First Approach', sideA: 'We should implement pricing now and invest the revenue into transit improvements', sideB: 'Transit alternatives must exist before pricing makes sense — otherwise we\'re charging people with no choice', relatedPostIds: ['p1', 'p6', 'p10', 'p2'] },
    { id: 't3', label: 'Universal Pricing vs. Targeted Exemptions', sideA: 'A simple universal fee is most effective and easiest to administer', sideB: 'Without broad exemptions and sliding scales, the policy becomes regressive', relatedPostIds: ['p5', 'p8', 'p9'] },
  ],

  clusters: [
    { id: 'c1', name: 'Equity & Affordability', description: 'Concerns about impact on low-income residents, working poor, and the income threshold for exemptions', postCount: 5, relatedPostIds: ['p2', 'p5', 'p7', 'p8', 'p9'] },
    { id: 'c2', name: 'Transit Infrastructure', description: 'Whether current public transit is adequate and how revenue should improve it', postCount: 4, relatedPostIds: ['p1', 'p6', 'p10', 'p2'] },
    { id: 'c3', name: 'Business Impact', description: 'Effects on small businesses, delivery costs, and commercial operations downtown', postCount: 3, relatedPostIds: ['p4', 'p8', 'p7'] },
    { id: 'c4', name: 'Implementation Design', description: 'Phasing, fee levels, exemption structures, oversight, and accountability mechanisms', postCount: 4, relatedPostIds: ['p9', 'p10', 'p1', 'p5'] },
  ],

  openQuestions: [
    { id: 'q1', question: 'Has anyone modeled the economic impact on local downtown businesses?', raisedInPostId: 'p4', raisedBy: 'Tom Brennan', relatedPostIds: ['p4', 'p8'] },
    { id: 'q2', question: 'How will revenue allocation be enforced and made accountable?', raisedInPostId: 'p6', raisedBy: 'Chen Wei', relatedPostIds: ['p6', 'p9'] },
    { id: 'q3', question: 'Is a phased approach with lower initial fees politically and practically viable?', raisedInPostId: 'p10', raisedBy: 'Sarah Johansson', relatedPostIds: ['p10', 'p9'] },
  ],

  guidance: [
    { id: 'g1', type: 'overrepresented', label: 'Cost concerns are well-covered', description: 'Multiple posts already address the financial burden. Consider building on existing points rather than restating them.', targetPostId: 'p2' },
    { id: 'g2', type: 'evidence-needed', label: 'Business impact data is missing', description: 'Tom and Mike raised business concerns, but no one has shared data on how congestion pricing affected businesses in other cities.', targetPostId: 'p4', suggestedArgdownType: 'evidence' },
    { id: 'g3', type: 'missing-perspective', label: 'No environmental justice voice yet', description: 'Linda mentioned health impacts, but no one from affected neighborhoods near highways has shared their experience.', targetPostId: 'p3', suggestedArgdownType: 'support' },
    { id: 'g4', type: 'gap', label: 'Alternative revenue models unexplored', description: 'Could the same goals be achieved through parking reform, employer levies, or other mechanisms? No one has compared alternatives.', suggestedArgdownType: 'alternative' },
    { id: 'g5', type: 'missing-counterargument', label: 'No rebuttal to phased approach', description: 'Sarah\'s phased proposal has strong support but no one has raised potential downsides or risks.', targetPostId: 'p10', suggestedArgdownType: 'objection' },
    { id: 'g6', type: 'missing-alternative', label: 'No non-pricing alternatives proposed', description: 'All discussion assumes some form of pricing. What about congestion-reducing alternatives like remote work incentives or staggered hours?', suggestedArgdownType: 'alternative' },
    { id: 'g7', type: 'unresolved-question', label: 'Accountability mechanism undefined', description: 'Chen Wei asked how revenue oversight would work. David mentioned a board but specifics are missing.', targetPostId: 'p6', suggestedArgdownType: 'support' },
  ],
};
...
export const stubTopics: TopicMeta[] = [
  ...
  },
  {
    ...
    status: 'active',
    author: { id: 'a11', name: 'Fatima Al-Rashid', avatar: 'FA', color: '190 45% 45%', role: 'Head Librarian' },
  ...
  },
  {
    ...
    author: { id: 'a12', name: 'Robert Nguyen', avatar: 'RN', color: '120 35% 42%', role: 'School Board Member' },
    createdAt: '2026-02-15T14:00:00Z',
    lastActivity: '2026-03-07T09:45:00Z',
    participantCount: 89,
    postCount: 24,
