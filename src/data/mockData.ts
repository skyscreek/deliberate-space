...
export const congestionTopic: Topic = {
  ...
  posts: [
    {
      id: 'p1', author: authors.maria, score: 24,
      ...
      replies: [{
        id: 'r1-1', author: authors.sarah, score: 14,
        ...
        replies: [{
          id: 'r1-1-1', author: authors.maria, score: 6,
    ...
    {
      id: 'p2', author: authors.james, score: 31,
    ...
    {
      id: 'p3', author: authors.linda, score: 16,
      ...
      replies: [{
        id: 'r3-1', author: authors.james, score: 19,
    ...
    {
      id: 'p4', author: authors.tom, score: 18,
    ...
    {
      id: 'p5', author: authors.aisha, score: 34,
    ...
    {
      id: 'p6', author: authors.chen, score: 22,
    ...
    {
      id: 'p7', author: authors.priya, score: 11,
      ...
      replies: [{
        id: 'r7-1', author: authors.tom, score: 12,
    ...
    {
      id: 'p8', author: authors.mike, score: 17,
    ...
    {
      id: 'p9', author: authors.david, score: 9,
      ...
      replies: [{
        id: 'r9-1', author: authors.aisha, score: 15,
    ...
    {
      id: 'p10', author: authors.sarah, score: 28,
  ...
  guidance: [
    { id: 'g1', type: 'overrepresented', label: 'Cost concerns are well-covered', description: 'Multiple posts already address the financial burden. Consider building on existing points rather than restating them.' },
    { id: 'g2', type: 'evidence-needed', label: 'Business impact data is missing', description: 'Tom and Mike raised business concerns, but no one has shared data on how congestion pricing affected businesses in other cities.' },
    { id: 'g3', type: 'missing-perspective', label: 'No environmental justice voice yet', description: 'Linda mentioned health impacts, but no one from affected neighborhoods near highways has shared their experience.' },
    { id: 'g4', type: 'gap', label: 'Alternative revenue models unexplored', description: 'Could the same goals be achieved through parking reform, employer levies, or other mechanisms? No one has compared alternatives.' },
    { id: 'g5', type: 'missing-counterargument', label: 'No rebuttal to phased approach', description: 'Sarah\'s phased proposal has strong support but no one has raised potential downsides or risks.' },
    { id: 'g6', type: 'missing-alternative', label: 'No non-pricing alternatives proposed', description: 'All discussion assumes some form of pricing. What about congestion-reducing alternatives like remote work incentives or staggered hours?' },
    { id: 'g7', type: 'unresolved-question', label: 'Accountability mechanism undefined', description: 'Chen Wei asked how revenue oversight would work. David mentioned a board but specifics are missing.' },
  ],
};
